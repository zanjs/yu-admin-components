...
export default {
  name: 'yu-layout-header-aside-menu-header',
  mixins: [
    menuMixin
  ],
  render (createElement) {
    return createElement('div', {
      ...
      class: { 'yu-theme-header-menu': true, 'is-scrollable': this.isScroll },
      ref: 'page'
    }, [
      createElement('div', {
        attrs: { class: 'yu-theme-header-menu__content', flex: '', 'flex-box': '1' },
        ref: 'content'
      }, [
        createElement('div', {
          attrs: { class: 'yu-theme-header-menu__scroll', 'flex-box': '0' },
      ...
      ...this.isScroll ? [
        createElement('div', {
          attrs: { class: 'yu-theme-header-menu__prev', flex: 'main:center cross:center', 'flex-box': '0' },
          on: { click: () => this.scroll('left') }
        }, [
          createElement('i', { attrs: { class: 'el-icon-arrow-left' } })
        ]),
        createElement('div', {
          attrs: { class: 'yu-theme-header-menu__next', flex: 'main:center cross:center', 'flex-box': '0' },
